...
void Vencode42c___024root__trace_chg_sub_0(Vencode42c___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vencode42c___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode42c___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vencode42c___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vencode42c___024root__trace_chg_sub_0(Vencode42c___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vencode42c__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode42c___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vencode42c___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode42c___024root__trace_cleanup\n"); );
    // Init
    Vencode42c___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencode42c___024root*>(voidSelf);
    Vencode42c__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
